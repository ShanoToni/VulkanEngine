...
ShaderBase::ShaderBase(const std::vector<Mesh*> meshesToAdd) {
...
void ShaderBase::initShaderPipeline(float W, float H,
    ...
    BasicVertexInputInfo.pVertexAttributeDescriptions =
    ...
    if (vkCreateGraphicsPipelines(device, VK_NULL_HANDLE, 1, &pipelineInfo,
                                  nullptr, &ShaderPipeline) != VK_SUCCESS) {
