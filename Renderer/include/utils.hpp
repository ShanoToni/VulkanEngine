...
static inline uint32_t findMemoryType(uint32_t typeFilter,
...
static inline VkCommandBuffer beginSingleTimeCommands(VkCommandPool commandPool,
                                                      VkDevice device) {
...
static inline void createBuffer(VkDeviceSize size, VkBufferUsageFlags usage,
                                VkMemoryPropertyFlags properties,
...
static inline void copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer,
...
static inline void createImage(uint32_t widht, uint32_t height, VkFormat format,
...
transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout,
                      ...
                      VkDevice device, VkQueue graphicsQueue, int layerCount) {
    VkCommandBuffer commandBuffer =
        beginSingleTimeCommands(commandPool, device);
